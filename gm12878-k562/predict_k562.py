...
from model import DeepCBS_Network_Network
...
if __name__ == '__main__':
    ...
    #sample_data = [X[i] for i in sample_list] 
    #sample_label = [y[i] for i in sample_list]
    #X_test_=np.array(sample_data)
    #y_test_=np.array(sample_label)
    X_test_=X
    y_test_=y
