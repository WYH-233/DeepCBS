...
def draw_ROC_Curve(output_list, output_result_list, correct_list, name):
    ...
    plt.xlabel('False Positive Rate')
    plt.legend(loc="lower right")
    plt.savefig( name + '_' + str(AUC) + ".png")
    plt.close()
    return AUC, pr_auc, F1,threshold,fpr,tpr
